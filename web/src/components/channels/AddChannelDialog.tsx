...
import { MessageSquare, Camera, Send, Network, QrCode } from "lucide-react";
...
const channelOptions: ChannelOption[] = [
  ...
  {
    id: "whatsapp_qr",
    name: "WhatsApp por QR (self-hosted)",
    description:
      "Conecta un numero de WhatsApp Business escaneando un codigo QR desde el telefono. Canal no oficial via servidor propio (WAHA).",
