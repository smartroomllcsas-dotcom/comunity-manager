...
const channelOptions: ChannelOption[] = [
  ...
  {
    id: "waha",
    name: "WhatsApp (WAHA · Beta)",
    description:
      "Conecta cualquier número por QR usando nuestro servidor WAHA autohospedado. Canal no oficial: riesgo de baneo si se detecta uso automatizado agresivo.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-8 w-8 text-emerald-500 fill-current">
                      ...
                      <CardContent className="p-4 flex flex-col gap-3">
                        ...
                        <div className="mt-auto">
                          ...
                          channel.available ? (
                            ...
                            />
                          ) : channel.id === "waha" && channel.available ? (
                            <WahaConnect
                              brandId={brandId}
                              onConnected={() => {
                                onChannelAdded?.();
