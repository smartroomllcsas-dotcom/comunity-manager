            ...
            filtered.map((d) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left rounded-md border p-2 mb-1.5"
                  style={{
                    borderColor: active ? 'oklch(70% 0.14 250)' : 'var(--border)',
                    background: active ? 'oklch(70% 0.14 250 / 0.1)' : 'var(--surface-1)',
                  }}
                >
