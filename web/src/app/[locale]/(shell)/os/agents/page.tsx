...
const AGENT_TEMPLATES: AgentTemplate[] = [
  { id: 'auto-responder', name: 'Auto-responder', role: 'Bandeja', description: 'Responde mensajes entrantes en WA/Messenger/IG con tono de marca y contexto de conversación', icon: MessageCircle, color: 'var(--os-ok)', model: 'claude-sonnet-4-6', skills: ['auto.respond', 'inbox.sentiment'], status: 'live', trust: 0.92 },
  { id: 'lead-qualifier', name: 'Lead-qualifier', role: 'Comercial', description: 'Aplica scorecard BANT/CHAMP, marca leads calientes y agenda citas en calendario', icon: Target, color: 'var(--os-accent)', model: 'claude-haiku-4-5', skills: ['lead.qualify', 'lead.book_slot', 'lead.followup'], status: 'live', trust: 0.88 },
