...
const AGENT_TEMPLATES: AgentTemplate[] = [
  { id: 'auto-responder', name: 'Auto-responder', role: 'Bandeja', description: 'Responde mensajes entrantes en WA/Messenger/IG con tono de marca y contexto de conversación', icon: MessageCircle, color: 'var(--os-ok)', model: 'claude-sonnet-4-6', skills: ['auto.respond', 'inbox.sentiment'], status: 'template' },
  { id: 'lead-qualifier', name: 'Lead-qualifier', role: 'Comercial', description: 'Aplica scorecard BANT/CHAMP, marca leads calientes y agenda citas en calendario', icon: Target, color: 'var(--os-accent)', model: 'claude-haiku-4-5', skills: ['lead.qualify', 'lead.book_slot', 'lead.followup'], status: 'template' },
  { id: 'content-writer', name: 'Content-writer', role: 'Contenido', description: 'Genera borradores de post, captions con hashtags, y sugiere calendario editorial por pilar', icon: PenTool, color: 'oklch(72% 0.15 320)', model: 'claude-opus-4-7', skills: ['content.draft', 'content.caption', 'content.hashtags'], status: 'template' },
  { id: 'escalator', name: 'Escalator-agent', role: 'Bandeja', description: 'Detecta conversaciones que requieren humano (queja fuerte, dudas complejas) y escala vía Slack', icon: Shield, color: 'oklch(65% 0.15 25)', model: 'claude-haiku-4-5', skills: ['human.escalate', 'inbox.sentiment'], status: 'template' },
  { id: 'analytics-agent', name: 'Analytics-agent', role: 'Analytics', description: 'Reporte semanal automático, scan de competidores y detección de anomalías en engagement', icon: BarChart3, color: 'var(--os-warn)', model: 'claude-sonnet-4-6', skills: ['analytics.weekly', 'analytics.competitor', 'analytics.engagement'], status: 'template' },
  ...
  { id: 'brain-agent', name: 'Brain-agent', role: 'Ops', description: 'Captura notas de voz, indexa conversaciones, mantiene knowledge graph de contactos', icon: Sparkles, color: 'var(--os-accent)', model: 'claude-sonnet-4-6', skills: ['brain.dump'], status: 'template' },
  { id: 'conductor', name: 'Conductor', role: 'Ops', description: 'Meta-agente: coordina otros agentes, asigna tareas, decide escalaciones a humano', icon: Bot, color: 'var(--os-warn)', model: 'claude-opus-4-7', skills: ['ops.broadcast'], status: 'template' },
];
