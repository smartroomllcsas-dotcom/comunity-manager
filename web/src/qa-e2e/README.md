# Pruebas E2E de QA (Billing / Suscripciones)

Suite de QA a nivel de servicio/integración que **importa los módulos reales**
del sistema y los ejecuta contra un **Supabase en memoria** (sin red, sin BD
...
- `epayco.test.ts` — Req 2: ePayco aprobado/rechazado/pendiente.
...
El informe de evidencias está en `docs/qa-evidence-e2e.md`.
