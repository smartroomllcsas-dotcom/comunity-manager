---
name: claude-api
description: Reference for Claude API / Anthropic SDK — models, pricing, streaming, tool use, MCP, agents, caching, migration. Trigger when the code or prompt names Claude/Anthropic/Opus/Sonnet/Haiku or imports `anthropic`. Skip if OpenAI/GPT/Gemini/Llama is being worked on.
