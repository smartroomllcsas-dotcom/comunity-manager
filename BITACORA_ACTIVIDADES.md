...
### 11 sep 2026
- **Módulo de Comentarios** (nuevo en el menú), por empresa: llegan los comentarios de publicaciones y pautas de Facebook e Instagram; se pueden responder en público y escribirle al interno a quien comentó. Ese mensaje abre el chat en la Bandeja con el contacto creado, y cuando la persona responde el agente de la empresa sigue la conversación. Configurable: automático (respuesta pública y/o mensaje al interno) o manual, con textos propios, palabras clave para filtrar y "sólo el primer comentario de cada persona". Migración **050** aplicada y suscripción a los avisos de Meta (`feed` y `comments`) al activar. Límite de Meta: un solo mensaje al interno por comentario y dentro de 7 días.
