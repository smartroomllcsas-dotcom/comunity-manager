...
### 11 sep 2026
- **Permisos de comentarios**: se piden `pages_manage_engagement` e `instagram_manage_comments` al conectar. Pendiente en el panel de Meta (app Community ManagerWA, id 1491695645279792): activarlos en el caso de uso y en la configuración de Login for Business, y marcar los campos `feed` (Página) y `comments` (Instagram) en Webhooks. Después hay que reconectar Facebook e Instagram de cada empresa. Pasos en `web/docs/COMENTARIOS_META.md`. Sin eso funciona recibir comentarios y escribir al interno; lo que falla es responder en público.
